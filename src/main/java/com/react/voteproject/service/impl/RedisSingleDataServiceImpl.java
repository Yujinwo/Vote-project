package com.react.voteproject.service.impl;

import com.react.voteproject.config.RedisConfig;
import com.react.voteproject.redis.RedisHandler;
import com.react.voteproject.service.RedisSingleDataService;
...
public class RedisSingleDataServiceImpl implements RedisSingleDataService {
    ...
    public String getSingleData(String key) {
        if (redisHandler.getValueOperations().get(key) == null) return null;
